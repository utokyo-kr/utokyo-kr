...
import { applyNav } from "/OB/board/nav.js?v=324";
import { boardInfo, boardTags, tagInfo } from "/OB/board/board-info.js?v=324";
...
async function drawAssembly(cat) {
  ...
  let mod = null;
  try { mod = await import("/OB/board/assembly-intro.js?v=324"); } catch (e) { return; }
