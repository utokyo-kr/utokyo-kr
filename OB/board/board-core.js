...
import { applyNav } from "/OB/board/nav.js?v=323";
import { boardInfo, boardTags, tagInfo } from "/OB/board/board-info.js?v=323";
...
async function drawAssembly(cat) {
  ...
  let mod = null;
  try { mod = await import("/OB/board/assembly-intro.js?v=323"); } catch (e) { return; }
